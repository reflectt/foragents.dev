      ...
      <section className="max-w-6xl mx-auto px-4 pb-6">
        <div className="relative max-w-md mx-auto">
          <input
            ...
            className="w-full px-4 py-3 pl-11 bg-white/5 border border-white/10 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-primary/50 transition-colors"
          />
          <svg
            ...
            <button
              ...
              className={`px-3 py-2 rounded-lg font-medium text-sm transition-all ${
                selectedDifficulty === difficulty.id
                  ...
                  : "bg-white/5 text-gray-400 border border-white/10 hover:border-primary/30 hover:text-gray-300"
              }`}
            >
              {difficulty.label}
            </button>
              ...
              {guides.map((guide) => {
                ...
                return (
                  <Link
                    ...
                    className="group bg-white/5 border border-white/10 rounded-xl p-6 hover:border-primary/30 hover:bg-white/[0.07] transition-all"
                  >
