        ...
        <form className="grid gap-4" onSubmit={handleSubmit}>
          ...
          <div className="flex items-center justify-between gap-4">
            <button
              type="submit"
              disabled={submitting}
              className="px-6 py-3 bg-primary text-background font-semibold rounded-lg hover:brightness-110 disabled:opacity-70"
            >
                  ...
                  <div className="flex items-center justify-between gap-3">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        ...
                        className="px-3 py-2 rounded-lg bg-primary text-background font-semibold disabled:opacity-60"
                      >
                        {projectHasVote
                          ? "Voted"
