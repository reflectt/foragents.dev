...
const badgeClassByType: Record<BookmarkItemType, string> = {
  ...
  mcp: "bg-purple/10 text-purple border-purple/30",
  collection: "bg-destructive/10 text-purple border-destructive/30",
  guide: "bg-electric-blue/10 text-primary border-electric-blue/30",
