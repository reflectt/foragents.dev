            ...
            <CardContent className="p-8">
              <div className="prose prose-invert max-w-none">
                ...
                <div className="flex flex-wrap gap-3 mt-8">
                  <Link
                    href="/submit"
                    className="inline-flex items-center justify-center px-6 py-3 rounded-lg bg-cyan text-primary-foreground font-semibold hover:brightness-110 transition-all"
                  >
                    Submit a Skill
                  </Link>
                  <Link
