...
export default async function NetworkSecurityPage() {
  const guides = (await readSecurityGuides()).filter((guide) => guide.category === "network");
  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-5xl">
      ...
      <p className="text-lg text-gray-600 mb-8">
        Category-filtered view of persistent guidance for secure transport, authentication, webhook verification,
