        ...
        <div className="relative max-w-4xl mx-auto px-4 py-20 text-center">
          ...
          <div className="max-w-xl mx-auto">
            <input
              ...
              className="w-full rounded-lg border border-white/10 bg-card/40 px-4 py-2.5 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:border-primary/40"
            />
          </div>
        </div>
      </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {integrations.map((integration) => (
                <Link
                  ...
                  className="block"
                >
                  <Card className="relative overflow-hidden bg-card/30 border-white/10 hover:border-primary/30 transition-all group h-full">
