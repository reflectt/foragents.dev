        ...
        <div className="relative max-w-4xl mx-auto px-4 py-16">
          ...
          <div className="flex flex-wrap gap-3">
            <button
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg bg-primary text-background font-semibold text-sm hover:brightness-110 transition-all disabled:opacity-60"
            >
          ...
          <CardContent>
            <div className="flex items-center gap-2 flex-wrap">
              ...
              <button
                ...
                className="ml-2 px-4 py-1.5 rounded-md bg-primary text-background text-sm font-semibold disabled:opacity-60"
              >
