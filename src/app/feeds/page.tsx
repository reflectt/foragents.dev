    ...
    <div className="min-h-screen">
      ...
      <section className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="mt-12 text-center">
          ...
          <Link
            href="/submit"
            className="inline-flex items-center justify-center h-10 px-6 rounded-lg bg-cyan text-background font-semibold text-sm hover:brightness-110 transition-all"
          >
            Request a Feature
          </Link>
        </div>
