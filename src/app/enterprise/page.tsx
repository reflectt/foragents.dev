...
export default function EnterprisePage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative max-w-7xl mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((feature) => {
            ...
            return (
              <Card key={feature.title} className="bg-background border-white/10 hover:border-primary/30 transition-colors">
                <CardHeader>
      ...
      <section className="relative max-w-7xl mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
          {trustedByCompanies.map((company) => (
            <div
              key={company}
              className="flex items-center justify-center p-6 bg-background border border-white/10 rounded-lg hover:border-primary/30 transition-colors"
            >
      ...
      {/* Compliance Section */}
      <section className="relative max-w-7xl mx-auto px-4 py-16">
        <div className="bg-background border border-white/10 rounded-2xl p-8 md:p-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-10">
            {complianceBadges.map((badge) => (
              <div
                key={badge.name}
                className="flex flex-col items-center justify-center p-6 bg-background border border-white/5 rounded-lg"
              >
      ...
      <section className="relative max-w-7xl mx-auto px-4 py-16">
        <div className="relative overflow-hidden bg-gradient-to-br from-primary/10 to-primary/5 border border-primary/20 rounded-2xl p-8 md:p-12 text-center">
          <div className="absolute inset-0">
          ...
          <div className="relative">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <Link
                href="/security"
                className="inline-flex items-center gap-2 px-6 py-3 text-white font-semibold hover:text-primary transition-colors"
              >
