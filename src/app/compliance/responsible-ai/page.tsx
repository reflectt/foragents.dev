    ...
    <div className="min-h-screen bg-background">
      <section className="relative overflow-hidden min-h-[300px] flex items-center">
        ...
        <div className="relative max-w-5xl mx-auto px-4 py-16 w-full">
          ...
          <Badge className="mb-4 bg-primary/10 text-primary border-primary/20">Ethics Policies (Live)</Badge>
          <h1 className="text-[40px] md:text-[48px] font-bold tracking-[-0.02em] text-foreground mb-4">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              {principles.map((principle) => (
                <div key={principle.title} className="rounded-lg border border-white/10 bg-black/20 p-4">
                  <h3 className="font-semibold mb-2 text-foreground">{principle.title}</h3>
              ...
              {ethicsPolicies.map((policy) => (
                <article key={policy.id} className="rounded-lg border border-white/10 bg-black/20 p-4">
                  <div className="flex flex-wrap items-center gap-2 mb-2">
                    <h3 className="font-semibold text-base text-foreground">{policy.title}</h3>
      ...
      <div className="max-w-5xl mx-auto px-4 py-12">
        <div className="flex gap-4 justify-between">
          <Link href="/compliance" className="text-sm text-foreground/60 hover:text-primary transition-colors">
            ← Back to Compliance Hub
          </Link>
          <Link href="/compliance/governance" className="text-sm text-primary hover:underline">
