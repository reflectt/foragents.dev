...
export default function DiffPage() {
    ...
    return (
      <div className="grid grid-cols-2 gap-px bg-white/5 font-mono text-sm overflow-auto">
        ...
        <div className="overflow-auto">
          <div className="sticky top-0 bg-background border-b border-white/10 px-4 py-2 text-sm font-semibold text-white z-10">
            {version1}
          </div>
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {diffResult && (
        <section className="max-w-7xl mx-auto px-4 pb-8">
          <Card className="bg-gradient-to-br from-primary/10 via-card/80 to-purple/5 border-primary/30">
