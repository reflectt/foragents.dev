  ...
  return (
    <div className="min-h-screen bg-background">
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {featuredPartners.map((partner) => (
                    <Card
                      key={partner.id}
                      className="relative overflow-hidden bg-card/40 border-primary/30 ring-1 ring-primary/20"
                    >
                      <CardHeader>
                        <div className="flex items-center justify-between gap-3">
                          ...
                          <Badge className="bg-primary/20 text-primary/70 border-primary/30">Featured</Badge>
                        </div>
      ...
      <section id="apply" className="max-w-3xl mx-auto px-4 py-16">
        <Card className="bg-gradient-to-br from-primary/5 via-card/80 to-purple/5 border-primary/20">
          <CardHeader>
          ...
          <CardContent>
            <form className="space-y-4" onSubmit={handleApply}>
              ...
              <button
                type="submit"
                disabled={submitting}
                className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-lg bg-primary text-background font-semibold text-sm hover:brightness-110 transition-all disabled:opacity-50"
              >
