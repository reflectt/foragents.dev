  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="max-w-5xl mx-auto px-4 py-16">
        ...
        {/* Video Placeholder */}
        <div className="relative overflow-hidden rounded-xl border border-white/10 bg-gradient-to-br from-primary/20 via-purple/10 to-primary/10 aspect-video flex items-center justify-center group cursor-pointer hover:border-primary/30 transition-all">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {demos.map((demo, index) => (
            ...
            >
              ...
              <div className="relative overflow-hidden bg-gradient-to-br from-primary/10 via-purple/5 to-transparent aspect-video flex items-center justify-center">
                <div className="absolute inset-0 bg-gradient-to-br from-primary/5 via-transparent to-purple/5" />
