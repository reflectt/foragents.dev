  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="max-w-4xl mx-auto px-4 py-16">
        <Card className="bg-gradient-to-br from-purple/5 via-card/80 to-[#06D6A0]/5 border-primary/30">
          <CardHeader>
      ...
      {/* CTA */}
      <section className="max-w-4xl mx-auto px-4 py-16">
        <div className="relative overflow-hidden rounded-2xl border border-primary/20 bg-gradient-to-br from-[#06D6A0]/5 via-card/80 to-cyan-500/5">
