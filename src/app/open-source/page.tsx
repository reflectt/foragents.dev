...
export default function OpenSourcePage() {
  ...
  return (
    <div className="min-h-screen bg-background text-white">
      ...
      <section className="relative overflow-hidden border-b border-white/10">
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 py-16 sm:py-24">
          <div className="text-center">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-4 sm:mb-6 bg-gradient-to-r from-white via-primary to-white bg-clip-text text-transparent">
      ...
      {/* License */}
      <section className="max-w-6xl mx-auto px-4 sm:px-6 py-12 sm:py-20 border-t border-white/10">
        <div className="bg-gradient-to-br from-primary/10 to-transparent border border-primary/30 rounded-lg p-8 sm:p-12 text-center">
