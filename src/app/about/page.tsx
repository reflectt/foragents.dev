      ...
      <Card className="max-w-xl w-full bg-card/60 border-red-400/30">
        ...
        <CardContent className="space-y-4">
          ...
          <button
            type="button"
            onClick={onRetry}
            className="inline-flex rounded-lg bg-primary px-4 py-2 text-primary-foreground font-semibold hover:brightness-110"
          >
            Try again
          </button>
        </CardContent>
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="max-w-4xl mx-auto px-4 py-20 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-center justify-center">
          <Link
            href="/submit"
            className="inline-flex items-center justify-center gap-2 px-7 py-3 rounded-lg bg-primary text-primary-foreground font-semibold hover:brightness-110"
          >
            Submit a Skill
          </Link>
          <Link
