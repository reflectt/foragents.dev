                  ...
                  >
                    ...
                    <CardContent>
                      ...
                      <Button
                        ...
                        className="bg-cyan hover:bg-cyan/90 text-primary-foreground font-semibold"
                      >
                        {isPast
                          ? "Event closed"
                          : atCapacity
            ...
            <CardContent>
              <form onSubmit={submitEvent} className="space-y-4">
                ...
                <Button
                  type="submit"
                  disabled={submitting}
                  className="w-full bg-cyan hover:bg-cyan/90 text-primary-foreground font-semibold"
                >
