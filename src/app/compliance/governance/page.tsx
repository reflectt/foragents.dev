    ...
    <div className="min-h-screen bg-background">
      <section className="relative overflow-hidden min-h-[300px] flex items-center">
        ...
        <div className="relative max-w-5xl mx-auto px-4 py-16 w-full">
          ...
          <Badge className="mb-4 bg-primary/10 text-primary border-primary/20">Live Policy Data</Badge>
      ...
      <div className="max-w-5xl mx-auto px-4 py-12">
        <div className="flex gap-4 justify-between">
          ...
          <Link href="/compliance/responsible-ai" className="text-sm text-primary hover:underline">
            Responsible AI →
          </Link>
        </div>
      </div>
