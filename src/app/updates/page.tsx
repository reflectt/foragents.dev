  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="max-w-3xl mx-auto px-4 py-12">
        ...
        {/* Subscribe CTA */}
        <Card className="bg-gradient-to-r from-[#06D6A0]/10 to-purple/10 border-primary/20 mb-12">
        ...
        <div className="mt-12 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            <Link
              href="/requests"
              className="inline-flex items-center justify-center h-10 px-6 rounded-lg bg-primary text-primary-foreground font-semibold text-sm hover:brightness-110 transition-all"
            >
              Request a Feature
            </Link>
            <Link
