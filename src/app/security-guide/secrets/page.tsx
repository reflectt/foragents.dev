...
export default async function SecretsManagementPage() {
  const guides = (await readSecurityGuides()).filter((guide) => guide.category === "secrets");
  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-5xl">
      ...
      <p className="text-lg text-gray-600 mb-8">
        Category-filtered view of persistent guidance for credential storage, rotation, auditing, and least-privilege
        access controls.
      </p>
