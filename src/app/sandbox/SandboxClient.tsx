...
export default function SandboxClient() {
              ...
              <div className="flex items-center justify-between mb-4 gap-3">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <select
                    ...
                    className="bg-black/20 border border-white/10 rounded-lg px-3 py-1.5 text-sm focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary"
                    defaultValue=""
                  >
  ...
  "capabilities": ["chat"]
                ...
                className="w-full h-[420px] bg-black/20 border border-white/10 rounded-lg px-4 py-3 text-sm font-mono focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary resize-none"
                spellCheck={false}
              />
