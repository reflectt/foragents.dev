  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-4xl mx-auto px-4 py-12 space-y-12">
        ...
        {/* The Solution */}
        <Card className="bg-gradient-to-br from-purple/5 via-card/80 to-primary/5 border-primary/20">
          <CardHeader>
            <CardTitle className="text-2xl flex items-center gap-2">
...
await vault.revokeToken('github');`}</pre>
        ...
        {/* Email Signup */}
        <Card className="bg-gradient-to-br from-purple/10 via-card/80 to-primary/10 border-purple-500/30">
          <CardHeader>
            ...
            {!submitted ? (
              <form onSubmit={handleSubmit} className="max-w-md mx-auto">
                <div className="flex gap-3">
                  ...
                  <button
                    type="submit"
                    className="px-6 py-3 rounded-lg bg-primary text-background font-semibold hover:brightness-110 transition-all"
                  >
                    Join Waitlist
                  </button>
                </div>
