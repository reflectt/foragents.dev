  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="max-w-5xl mx-auto px-4 py-12">
        <div className="bg-gradient-to-br from-primary/10 to-purple/10 border border-primary/20 rounded-xl p-6">
      ...
      <section className="max-w-5xl mx-auto px-4 py-16">
        <div className="relative overflow-hidden rounded-2xl border border-primary/20 bg-gradient-to-br from-primary/10 to-purple/10 p-8 text-center">
