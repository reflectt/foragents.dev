    ...
    <html lang="en" className="dark">
      ...
      >
        <ToastProvider>
          <a
            href="#main-content"
            className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-50 focus:px-4 focus:py-2 focus:bg-cyan focus:text-primary-foreground focus:font-semibold focus:rounded-lg"
          >
