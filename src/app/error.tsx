      ...
      <div className="relative max-w-md w-full">
        ...
        <div className="relative bg-card/50 border border-white/10 rounded-2xl p-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <button
              onClick={reset}
              className="inline-flex items-center justify-center h-12 px-6 rounded-lg bg-cyan text-background font-semibold text-sm hover:brightness-110 transition-all"
            >
              Try again
            </button>
            <Link
