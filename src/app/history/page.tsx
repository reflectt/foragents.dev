      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        ...
        {history.length > 0 ? (
                  ...
                  >
                    <div className="flex justify-between items-start mb-3">
                      ...
                      <button
                        ...
                        className="px-4 py-2 bg-primary hover:bg-primary/80 text-black rounded font-medium transition-colors"
                      >
          ...
          <div className="text-center py-16">
            ...
            <Link
              href="/"
              className="inline-block px-6 py-3 bg-primary hover:bg-primary/80 text-black rounded font-medium transition-colors"
            >
              Browse Skills
            </Link>
          </div>
