    ...
    <div className="min-h-screen">
      ...
      <section id="main-content" className="relative overflow-hidden min-h-[600px] flex items-center">
        ...
        <div className="relative max-w-[640px] mx-auto px-4 py-20 md:py-24 text-center">
          ...
          <h1 className="text-[32px] md:text-[56px] font-bold tracking-[-0.02em] text-foreground mb-4 leading-tight">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mt-8">
            <Link
              href="/mcp"
              className="inline-flex items-center justify-center h-12 px-6 rounded-lg bg-cyan text-background font-semibold text-sm hover:brightness-110 transition-all hover:-translate-y-0.5 hover:shadow-lg"
            >
              Browse Servers
            </Link>
            <Link
          ...
          <div className="relative p-6 md:p-8">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
              <a
                ...
                className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-cyan text-background font-semibold text-sm hover:brightness-110 transition-all"
              >
                View on GitHub ↗
              </a>
              <Link
